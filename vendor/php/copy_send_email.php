...
$address = "eloisemecozzi@gmail.com";
...
$e_body = "Vous avez été contacté par M./Mme $name, voici le message : " . PHP_EOL . PHP_EOL;
$e_content = "\"$message\"" . PHP_EOL . PHP_EOL;
$e_reply = "Vous pouvez contacter M. ou Mme $name via email à cette adresse,\n" .  $email;
...
//$headers .= "Content-Type: multipart/mixed; boundary=\"" . $separator . "\"" . $eol;
      ...
      echo "<body>";
			...
			echo "<p>Merci <strong>M./Mme $name</strong>, votre message a été soumis à ma boite mail.</p>";
      echo "<p>pour revenir au formulaire de mail <a href='http://localhost/projets/boostrap-services/contact.php' style='color:#468ACF'>cliquez ici.</a></p>";
			echo "</div>";
			echo "</fieldset>";
      echo "</body>";
      echo "</html>";
      ...
      echo "<body>";
			echo "<fieldset>";
			echo "<div id='success_page'>";
			echo "<h3>Erreur ! le mail n'a pas pu etre envoyé, veuillez réessayer <a href='http://localhost/projets/boostrap-services/contact.php' style='color:#468ACF'>en cliquant ici.</a></h3>";
			echo "</div>";
			echo "</fieldset>";
      echo "</body>";
      echo "</html>";
